...
func main() {
	...
	client := core.NewClient(&core.ClientConfig{
		...
		Cmd:              exec.Command("./kv-core"),
		AllowedProtocols: []core.Protocol{
			core.ProtocolNetRPC, core.ProtocolGRPC},
	})
	defer client.Kill()
