...
var _ core.GRPCPlugin = &StreamerPlugin{}
...
func (p *StreamerPlugin) GRPCServer(broker *core.GRPCBroker, s *grpc.Server) error {
...
func (p *StreamerPlugin) GRPCClient(ctx context.Context, broker *core.GRPCBroker, c *grpc.ClientConn) (interface{}, error) {
