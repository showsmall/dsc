...
// 	protoc        (unknown)
// source: internal/core/grpc_stdio.proto
...
func (StdioData_Channel) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_core_grpc_stdio_proto_enumTypes[0].Descriptor()
}

func (StdioData_Channel) Type() protoreflect.EnumType {
	return &file_internal_core_grpc_stdio_proto_enumTypes[0]
}
...
func (StdioData_Channel) EnumDescriptor() ([]byte, []int) {
	return file_internal_core_grpc_stdio_proto_rawDescGZIP(), []int{0, 0}
}
...
type StdioData struct {
	...
	Channel StdioData_Channel `protobuf:"varint,1,opt,name=channel,proto3,enum=core.StdioData_Channel" json:"channel,omitempty"`
...
func (x *StdioData) Reset() {
	*x = StdioData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_core_grpc_stdio_proto_msgTypes[0]
...
func (*StdioData) Descriptor() ([]byte, []int) {
	return file_internal_core_grpc_stdio_proto_rawDescGZIP(), []int{0}
}
...
var File_internal_core_grpc_stdio_proto protoreflect.FileDescriptor

var file_internal_core_grpc_stdio_proto_rawDesc = []byte{
...
var (
	file_internal_core_grpc_stdio_proto_rawDescOnce sync.Once
	file_internal_core_grpc_stdio_proto_rawDescData = file_internal_core_grpc_stdio_proto_rawDesc
)

func file_internal_core_grpc_stdio_proto_rawDescGZIP() []byte {
	file_internal_core_grpc_stdio_proto_rawDescOnce.Do(func() {
		file_internal_core_grpc_stdio_proto_rawDescData = protoimpl.X.CompressGZIP(file_internal_core_grpc_stdio_proto_rawDescData)
	})
	return file_internal_core_grpc_stdio_proto_rawDescData
}

var file_internal_core_grpc_stdio_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_internal_core_grpc_stdio_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_internal_core_grpc_stdio_proto_goTypes = []interface{}{
	(StdioData_Channel)(0), // 0: core.StdioData.Channel
	(*StdioData)(nil),      // 1: core.StdioData
	(*emptypb.Empty)(nil),  // 2: google.protobuf.Empty
}
var file_internal_core_grpc_stdio_proto_depIdxs = []int32{
	0, // 0: core.StdioData.channel:type_name -> core.StdioData.Channel
	2, // 1: core.GRPCStdio.StreamStdio:input_type -> google.protobuf.Empty
	1, // 2: core.GRPCStdio.StreamStdio:output_type -> core.StdioData
...
func init() { file_internal_core_grpc_stdio_proto_init() }
func file_internal_core_grpc_stdio_proto_init() {
	if File_internal_core_grpc_stdio_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_internal_core_grpc_stdio_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_internal_core_grpc_stdio_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_internal_core_grpc_stdio_proto_goTypes,
		DependencyIndexes: file_internal_core_grpc_stdio_proto_depIdxs,
		EnumInfos:         file_internal_core_grpc_stdio_proto_enumTypes,
		MessageInfos:      file_internal_core_grpc_stdio_proto_msgTypes,
	}.Build()
	File_internal_core_grpc_stdio_proto = out.File
	file_internal_core_grpc_stdio_proto_rawDesc = nil
	file_internal_core_grpc_stdio_proto_goTypes = nil
	file_internal_core_grpc_stdio_proto_depIdxs = nil
}
