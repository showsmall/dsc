...
// 	protoc        (unknown)
// source: internal/core/grpc_broker.proto
...
func (x *ConnInfo) Reset() {
	*x = ConnInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_core_grpc_broker_proto_msgTypes[0]
...
func (*ConnInfo) Descriptor() ([]byte, []int) {
	return file_internal_core_grpc_broker_proto_rawDescGZIP(), []int{0}
}
...
func (x *ConnInfo_Knock) Reset() {
	*x = ConnInfo_Knock{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_core_grpc_broker_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConnInfo_Knock) Descriptor() ([]byte, []int) {
	return file_internal_core_grpc_broker_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_internal_core_grpc_broker_proto protoreflect.FileDescriptor

var file_internal_core_grpc_broker_proto_rawDesc = []byte{
...
var (
	file_internal_core_grpc_broker_proto_rawDescOnce sync.Once
	file_internal_core_grpc_broker_proto_rawDescData = file_internal_core_grpc_broker_proto_rawDesc
)

func file_internal_core_grpc_broker_proto_rawDescGZIP() []byte {
	file_internal_core_grpc_broker_proto_rawDescOnce.Do(func() {
		file_internal_core_grpc_broker_proto_rawDescData = protoimpl.X.CompressGZIP(file_internal_core_grpc_broker_proto_rawDescData)
	})
	return file_internal_core_grpc_broker_proto_rawDescData
}

var file_internal_core_grpc_broker_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_internal_core_grpc_broker_proto_goTypes = []interface{}{
	(*ConnInfo)(nil),       // 0: core.ConnInfo
	(*ConnInfo_Knock)(nil), // 1: core.ConnInfo.Knock
}
var file_internal_core_grpc_broker_proto_depIdxs = []int32{
	1, // 0: core.ConnInfo.knock:type_name -> core.ConnInfo.Knock
	0, // 1: core.GRPCBroker.StartStream:input_type -> core.ConnInfo
	0, // 2: core.GRPCBroker.StartStream:output_type -> core.ConnInfo
...
func init() { file_internal_core_grpc_broker_proto_init() }
func file_internal_core_grpc_broker_proto_init() {
	if File_internal_core_grpc_broker_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_internal_core_grpc_broker_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_core_grpc_broker_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_internal_core_grpc_broker_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_internal_core_grpc_broker_proto_goTypes,
		DependencyIndexes: file_internal_core_grpc_broker_proto_depIdxs,
		MessageInfos:      file_internal_core_grpc_broker_proto_msgTypes,
	}.Build()
	File_internal_core_grpc_broker_proto = out.File
	file_internal_core_grpc_broker_proto_rawDesc = nil
	file_internal_core_grpc_broker_proto_goTypes = nil
	file_internal_core_grpc_broker_proto_depIdxs = nil
}
