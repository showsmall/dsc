...
const (
	GRPCStdio_StreamStdio_FullMethodName = "/core.GRPCStdio/StreamStdio"
)
...
type GRPCStdioClient interface {
	...
	//
	// Callers should connect early to prevent blocking on the core process.
...
var GRPCStdio_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/core/grpc_stdio.proto",
}
