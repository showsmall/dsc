...
// ServerProtocol is an interface that must be implemented for new core
...
// ClientProtocol is an interface that must be implemented for new core
// protocols to be clients.
type ClientProtocol interface {
	io.Closer

	// Dispense dispenses a new instance of the core with the given name.
