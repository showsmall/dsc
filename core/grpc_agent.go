...
// AgentGRPCPlugin 是 go-core 的 Agent 适配器
...
// GRPCServer 实现
func (p *AgentGRPCPlugin) GRPCServer(broker *core.GRPCBroker, s *grpc.Server) error {
	proto.RegisterAgentServiceServer(s, &agentGRPCServer{impl: p.Impl})
	return nil
}

// GRPCClient 实现
func (p *AgentGRPCPlugin) GRPCClient(ctx context.Context, broker *core.GRPCBroker, c *grpc.ClientConn) (interface{}, error) {
